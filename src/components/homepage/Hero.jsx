            ...
            <div className="bg-white absolute inset-0">
                <div className='min-h-screen  flex lg:flex-row md:flex-row flex-col pt-10 relative px-6'>
                    <div className='flex flex-col justify-center'>
                        ...
                        <h1 className="lg:text-[0rem] md:text-[0rem] text-[4rem] text-transparent font-bold font-outline-2 color: black ">
                            DOGWIFHAT
                        </h1>
                    </div>
                    <div className='z-20'>
                        ...
                        <h1 className='color: black lg:text-8xl md:text-6xl text-5xl font-medium mt-4'>DOGWIFHAT</h1>
                        <h1 className='lg:text-8xl md:text-6xl text-5xl mt-2 text-purple-500 font-medium'></h1>
                        <p className='text-lg my-5'>NEW WAY TO <span className='text-purple-500'>LEARN</span> SKILLS</p>

                        <p className='text-lg my-10 max-w-md'>
                        "Join the Game with DOGWIFHAT - A Fresh Approach to Cryptocurrency With Constant Innovation and Endless Potential.”  
                        </p>
